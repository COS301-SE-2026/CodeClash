...
export interface IUserRepository {
    ...
    updateRatingsAfterMatch(match_id: string, winner_id: string, loser_id: string): Promise<{ winner: EloUpdateResultDTO, loser: EloUpdateResultDTO }>,
    updateEloAfterTournament(match_id: string, results: { user_id: string, placement: number }[]): Promise<EloUpdateResultDTO[]>,
