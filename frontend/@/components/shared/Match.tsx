...
export const MatchScreen: React.FC<MatchScreenProps> = ({
    ...
    return (
        <div className="fixed inset-0 flex flex-col">
            ...
            {/* Header */}
            <MatchCard className="w-full h-[10rem] mb-10 mt-10 ml-15 items-center">
            <div className='flex w-full justify-between items-center '>
                
                {/* Player 1 Progress */}
                <MatchCard className="w-md ml-7 my-auto">
                <div className="flex flex-row">
                    ...
                    <div className='flex flex-col items-start justify-between self-end'>
                        <Progress
                            value={player_life[0]}
                ...
                <div className='flex flex-row items-center justify-end'>
                    <img
                        src={avatars[1]}
                        alt="user 1 avatar"
                        className='scale-x-[-1] h-[5%] flex items-center mx-auto'
                    />
