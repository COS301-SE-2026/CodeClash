                    ...
                    questions?.map((q, id) => (
                        <React.Fragment key={id} >
                            <div className="flex justify-center items-center h-16">
                                {progress === id && <img src={avatar} className="w-20 h-20 object-cover rounded-full"></img>}
                            </div>
                            ...
                            <div className="flex justify-center  items-center h-16">
                                {opponent_progress === id &&  <img src={opponent} className="w-20 h-20 object-cover rounded-full"></img>}
                            </div>
                        </React.Fragment>
                    ))
                }
