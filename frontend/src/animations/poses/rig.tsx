...
export const StationaryLeftArm = () => {
    {/* the below segment of code is copied and pasted from my hand-written code on another page to save time, this code was not generated by ai, it has been pasted into this value here due to code duplication issues */}
    return(
        <motion.g>
...
export const StationaryRightArm = () => {
    return(
    // this code is copied and pasted for time reasons and is hand written, none of this code was generated by ai, it was copied and pasted to be placed inside this value due to code duplication issues
        <motion.g>
...
export const BothLegs = () => {
    return(
        // this code below is hand written and only copied and pasted here to save time, it has been pasted into this value due to duplicate code issues
        <motion.g>
