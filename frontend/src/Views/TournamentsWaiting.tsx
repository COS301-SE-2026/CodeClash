                ...
                <Card className="bg-card border-[var(--button-tournament-secondary)] border-[0.5px] flex flex-col ">
                    ...
                    <div className="flex flex-row w-full -mt-1">
                        ...
                        <div className="gap-5 flex flex-row ml-auto mr-6 -mt-5">
                            <MatchCard className="w-[60%] min-h-[40%] hover:opacity-90 hover:scale-105 transition-transform duration-300">
                            ...
                            <TournamentButton className="items-center h-[67%] justify-center px-2 py-2 rounded-sm">
                    ...
                    <div className="flex flex-col -mt-1">
                        <div className="flex flex-row">
                            ...
                            <div className="ml-auto font-semibold mr-6 text-[1.1rem]">4/8 Players</div>
                        </div>
                        <Progress value={50} className="w-[95%] mx-auto mt-2"/>
                    </div>

                    <div className="flex flex-row">
                        <Timer size={35} className="text-muted-text ml-5"/>
                        <div className="font-font font-semibold text-xs mt-3 ml-2">Time Until Start:</div>
                    </div>
                </Card>
