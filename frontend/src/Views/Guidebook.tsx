...
return(
    <div style={{backgroundImage: `url(${background})`}} className="w-full min-h-screen overflow-hidden bg-no-repeat object-cover bg-size-[auto_110%] bg-[right_40%_top_50%]">
        ...
        <div className="flex grid grid-rows-6 gap-15 w-[100%] mt-[15%]"> 
        ...
        <GameGuideCard className="ml-[8%]">
            ...
            <GameGuideCardText className="-ml-[62%] -mt-[7%] text-[70%]">Now you're in a match! Make sure you answer questions quickly to score more points than your opponent, but make sure they're correct first else you get no points!</GameGuideCardText>
        </GameGuideCard>
        <GameGuideCard className="ml-[8%]">
            <GameGuideNumberCard className="w-[34%] h-[100%] ml-[1%] -mt-[6.5%]">
