    ...
    <div style={{backgroundImage: `url(${book})`}} className="w-full min-h-screen overflow-hidden bg-no-repeat object-cover bg-size-[auto_2100px] bg-[right_-430px_top_-350px]">
        ...
        <div className="relative w-1/2 flex flex-col gap-10 -mt-5 overflow-hidden">
            <div className="grid grid-cols-2 grid-rows-4 gap-9 items-end relative overflow-hidden">
                ...
                <div className="w-[550px] h-[91px] bg-[#FFEFE0] opacity-[94%] rounded-[20px] border-[#F4A0B2] border-4 drop-shadow-[0px_4px_4px_rgba(0,0,0,0.25)] mb-12 -ml-40 relative">
                ...
                <div className="w-[550px] h-[91px] bg-[#FFEFE0] opacity-[94%] rounded-[20px] border-[#F4A0B2] border-4 drop-shadow-[0px_4px_4px_rgba(0,0,0,0.25)] mb-17 -ml-40 relative">
                ...
                <div className="w-[550px] h-[91px] bg-[#FFEFE0] opacity-[94%] rounded-[20px] border-[#F4A0B2] border-4 drop-shadow-[0px_4px_4px_rgba(0,0,0,0.25)] mb-19 -ml-40 relative">
        ...
        <div className="h-screen relative w-1/2 flex flex-col gap-10 ml-242 -mt-255.5 overflow-hidden">
            <div className="grid grid-cols-2 grid-rows-5 items-end relative overflow-hidden ml-25 mt-5">
                <div className="w-[160px] h-[160px] rounded-[20px] bg-[#FFD3DF] drop-shadow-[0px_4px_4px_rgba(0,0,0,0.25)]"></div>
            </div>
        </div>
    </div>
);
