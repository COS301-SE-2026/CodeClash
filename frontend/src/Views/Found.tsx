      ...
      <div className="searching-section">
        ...
        <div className="row-circles">
          <div className="purple-circle">
            <div className="searching-text">{username}</div>
          </div>
        ...
        <div className="row-elo">
          <div className="elo-button">
            <div className="elo-button-text">{elo} &nbsp; ELO</div>
          </div>
          <div className="elo-button">
        ...
        <div className="row-button">
          <button className="cancel-button" onClick={decline}>Decline Match</button>
          <button className="approve-button" onClick={accept}>Accept Match</button>
        </div>
      </div>
    </div>
  );
